...
// Whitelist (only for long-read mode)
if (params.input_type == 'short_read') {
    // For short-read, whitelist will be generated by UMI-tools
    blaze_whitelist = null
} else {
    // For long-read mode
    if (params.whitelist) {
        ...
        if (params.barcode_format && params.barcode_format.equals("10X_3v3")) {
            blaze_whitelist = file("$baseDir/assets/whitelist/3M-february-2018.zip")
        }
        else if (params.barcode_format && params.barcode_format.equals("10X_5v2")) {
            blaze_whitelist = file("$baseDir/assets/whitelist/737K-august-2016.txt.zip")
        }
        else if (params.barcode_format && params.barcode_format.equals("10X_3v4")) {
            blaze_whitelist = file("$baseDir/assets/whitelist/3M-3pgex-may-2023_TRU.txt.zip")
        }
        else if (params.barcode_format && params.barcode_format.equals("10X_5v3")) {
